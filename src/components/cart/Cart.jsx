    ...
    return (
        <div className="lg:px-14 sm:px-8 px-4 py-10">
            <div className="flex flex-col items-center mb-12">
                ...
                <p className="text-lg text-gray-600 mt-2">You have 0 items in your cart.</p>
            ...
            <div className="border-t-[1.5px] border-slate-200 py-4 flex sm:flex-row sm:px-0 px-2 flex-col sm:justify-between gap-4">
                ...
                <div className="flex text-sm gap-1 flex-col">
                    ...
                    <Link className="flex gap-2 items-center mt-2 text-slate-500 hover:text-gray-800 transition duration-300" to="/">
                        <MdArrowBack size={20} />
